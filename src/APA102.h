...
//
// Header-only APA102 / SK9822 driver, copied verbatim from the T-Dongle-C5
// vendor lib (lib/apa102-arduino). The LilyGO T-Dongle-C5's onboard RGB LED is
// an APA102 (2-wire clock+data, not a WS2812B), so skimmer_led drives it through
// this when SKIMMER_LED_APA102 is set. Pins are compile-time template params.
